...
export function App() {
    const data: BallsProps = {
        ...
        bounceCoolOff: 1000, // Same balls cannot bounce twice in the same period. They need to wait up to bounceCoolOff period
        maxSpeed: 100, // Maximum speed that can be assigned to each ball per axis
        showCells: false // If you want to visualize containing cells of balls. Hinders performance a lot if set to true. P.S. best used with low ball count to visualize (eg. 5)
    }
